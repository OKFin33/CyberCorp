# Independent method-consumption scenarios

These create disposable projects using the actual creation package. They are opt-in environment setup, not automatic semantic graders. Do not point them at business repositories. All identities and GitHub URLs are fictional; external sends, services and merges are prohibited. Local fake API behavior is not evidence of hosted GitHub or concurrent actors.
