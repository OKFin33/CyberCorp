...
Enumerate them, and repoint them according to the target layer's own rule about referencing from outside — read it there rather than assuming this file states it. A layer worth adopting will tell you what is stable enough to point at.
